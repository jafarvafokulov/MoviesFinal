...
//                .appendQueryParameter("year", "2020")//ADDED
    ...
    public static URL buildURLToVideos(int id, String lang){   //changed to public
    ...
    public static URL buildURLToReviews(int id, String lang){ //changed to public
    ...
    public static JSONObject getJSONForReviews(int id, String lang ) { //changed to public
